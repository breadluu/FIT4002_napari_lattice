...
def _has_real_gpu() -> bool:
    ...
    meaningfully evaluated on such a backend - including
    test_cpu_deskew.py::test_cpu_engine_matches_gpu_engine, which compares the CPU
    engine against cle.deskew_y/deskew_x and is gated by requires_real_gpu for the
    same reason.
    """
